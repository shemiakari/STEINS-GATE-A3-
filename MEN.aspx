<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MEN.aspx.cs" Inherits="A3.MEN" %>
...
<nav>
        ...
        <div class="w3-container" style="margin-top:50px; margin-left:140px;" id="showcase">
            <h1 class="w3-xxxlarge" style="font-family:Poppins;"><b>Men's Clothing</b></h1>
                <hr style="width:500px;border:5px solid dodgerblue; margin-top:0%;" class="w3-round"/>
        </div>
        <a class="custom-btn btn-5" href="Products.aspx">RETURN</a>
        <a class="custom-btn btn-5" href="Cart.aspx">CART</a>
        ...
        <div class="displaybox"> 
            <asp:Repeater ID="Products" runat="server" OnItemCommand="Products_ItemCommand" EnableViewState="false">
                <HeaderTemplate>
    </HeaderTemplate>
    <ItemTemplate>
  <div class="dis roll">
    ...
    <div class="disdis">
      <p class="w3-text-black" style="margin-top:-10px; font-weight:700"><asp:Label ID="lblItemName" runat="server" Text='<%# Eval("Name") %>'></asp:Label></p>
    </div>
    </div>
      <div class="image" >
    ...
    <asp:Button ID="btnAddToCart" runat="server" Text="ADD TO CART" CssClass="disbut" CommandArgument='<%# Eval("Name") %>'  OnClick="btnAddToCart_Click"/>
  </div>
</ItemTemplate>
    <FooterTemplate>
    </FooterTemplate>
